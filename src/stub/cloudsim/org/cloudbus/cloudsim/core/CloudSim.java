...
/**
 * Stub implementation of CloudSim core class for demonstration purposes
 */
public class CloudSim {
    ...
    public static void init(int numUsers, Calendar calendar, boolean traceFlag) {
        initialized = true;
        clock = 0.0;
        System.out.println("[CloudSim] Initialized with " + numUsers + " users");
    }
    
    public static boolean startSimulation() {
        if (!initialized) {
            System.out.println("[CloudSim] Error: CloudSim not initialized");
            return false;
        }
    ...
    public static void stopSimulation() {
        System.out.println("[CloudSim] Stopping simulation at time " + clock);
        initialized = false;
    }
